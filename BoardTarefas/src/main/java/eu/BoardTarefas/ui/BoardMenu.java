...
import eu.BoardTarefas.service.BoardColumnQueryService;
import eu.BoardTarefas.service.BoardQueryService;
import eu.BoardTarefas.service.CardQueryService;
import eu.BoardTarefas.service.CardService;
...
public class BoardMenu {
    ...
    private void moveCardToNextColumn() throws SQLException {
        ...
        var boardColumnInfo = entity.getBoardColumns().stream().map(bc -> new BoardColumnInfoDTO(bc.getId(), bc.getOrder(), bc.getKind())).toList();
        try (var connection = getConnection()) {
    ...
    private void unblockCard() throws SQLException {System.out.println("Informe o id do card que será desbloqueado");
        var cardId = scanner.nextLong();
